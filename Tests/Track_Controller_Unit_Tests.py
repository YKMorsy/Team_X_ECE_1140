...
class TestTrackController(unittest.TestCase):
    ...
    def test_AllFalseIsFalse (self):
        ...
        way.parse_plc()
        self.assertEqual(way.get_commanded_speed(), {1:0b000001000, 2:0b01000000, 3:0b00000011})
    ...
    def test_OnlyOccupancyTrue (self):
        ...
        way.set_statuses({1:False, 2:False, 3:False, 4:False, 5:False})
        way.set_suggested_speed({1:0b00011010, 2:0b00100111, 3:0b00010101})
        way.set_commanded_speed({1:0b000000000, 2:0b0000000, 3:0b00001000})
        way.set_speed_limit({1:0b000100000, 2:0b00010000, 3:0b00010000})
        issue = way.set_PLC("track_controller/PLCs/ParentheseTest.txt")
    ...
    def test_2istrue (self):
        ...
        way.parse_plc()
        self.assertEqual(way.get_commanded_speed(), {1:0b000001000, 2:0b01000000, 3:0b00010000})
